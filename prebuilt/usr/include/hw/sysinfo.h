...
#define HWI_TAG_NAME_dma		"dma"
#define HWI_TAG_ALIGN_dma		(sizeof(_Uint32t))
struct hwi_dma {
	struct hwi_prefix	prefix;
	_Uint32t			chnl;
};
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/services/system/public/hw/sysinfo.h $ $Rev: 660432 $" )
