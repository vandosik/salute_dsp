...
DEV_8250 *create_device(TTYINIT *dip, unsigned unit, int map_dev_mem);
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/devc/ser8250/proto.h $ $Rev: 746538 $")
#endif
