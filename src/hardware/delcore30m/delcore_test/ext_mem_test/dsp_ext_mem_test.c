...
// 	if ((arg_data = mmap_device_io(size_2, 0x40000000)) == MAP_DEVICE_FAILED)
// 	{
// 	    perror("SRC mmap err");
// 	    goto exit1;
// 	}
...
//     }
    ...
    (*(uint32_t*)arg_data) = arg_paddr; //set this arg_data to smth
