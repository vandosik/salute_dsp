...
extern void init_xzynq(unsigned channel, const char *init, const char *defaults);
extern void put_xzynq(int);

extern struct callout_rtn	display_char_xzynq;
extern struct callout_rtn	poll_key_xzynq;
extern struct callout_rtn	break_detect_xzynq;
...
/*
 * ------------------------------------------------------------------
 * 1892VM14 System-On-Chip support
 * ------------------------------------------------------------------
 */

extern void init_ser1892vm14(unsigned channel, const char *init, const char *defaults);
extern void put_ser1892vm14(int);

extern struct callout_rtn	display_char_mc1892vm14;
extern struct callout_rtn	poll_key_mc1892vm14;
extern struct callout_rtn	break_detect_mc1892vm14;
// 
// extern struct callout_rtn	interrupt_id_aitc;
// extern struct callout_rtn	interrupt_eoi_aitc;
// extern struct callout_rtn	interrupt_mask_aitc;
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/arm/cpu_startup.h $ $Rev: 704099 $" )
