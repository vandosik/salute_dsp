...
const struct armv_chip armv_chip_pxa210b = {
	.cpuid		= 0x2920,
	.name		= "pxa210",
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/arm/armv_chip_pxa210b.c $ $Rev: 644488 $" );
