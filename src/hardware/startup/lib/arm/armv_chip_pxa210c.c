...
const struct armv_chip armv_chip_pxa210c = {
	.cpuid		= 0x2d20,
	.name		= "pxa210",
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/arm/armv_chip_pxa210c.c $ $Rev: 644488 $" );
