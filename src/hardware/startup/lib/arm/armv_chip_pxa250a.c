...
const struct armv_chip armv_chip_pxa250a = {
	.cpuid		= 0x2100,
	.name		= "pxa250",
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/arm/armv_chip_pxa250a.c $ $Rev: 644488 $" );
