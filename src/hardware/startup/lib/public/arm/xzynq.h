 ...
 * -------------------------------------------------------------------------
 */
//#define XZYNQ_PERIPH_CLOCK	100000000
...
#define XZYNQ_GLOBAL_TIMER_INT_STS				0x08
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/public/arm/xzynq.h $ $Rev: 708520 $")
#endif
