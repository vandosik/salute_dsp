...
struct cmctr_entry {
	...
	_Uint64t	l1_hclk;
	_Uint64t	l3_pclk;
	_Uint32t	div_sys0_ctr;
	_Uint32t	div_sys1_ctr;
};
...
struct hwinfo_entry {
	__FLEXARY(unsigned long, data); /* data[] variable sized, see <hw/sysinfo.h> */
};
...
struct smp_entry {
	_SPFPTR 			(void, send_ipi, (struct syspage_entry *, unsigned, unsigned, unsigned *));
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/services/system/public/sys/syspage.h $ $Rev: 680334 $")
#endif
