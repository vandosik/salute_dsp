...
void mc1892vm14_hwinit(void)
{
	...
	//Turns DSP0 / DSP1 / DSP interface / JPEG encoder on
	out32(MC1892VM14_CMCTR_BASE + MC1892VM14_CMCTR_GATE_DSP_REG,
		in32(MC1892VM14_CMCTR_BASE + MC1892VM14_CMCTR_GATE_DSP_REG) |
									MC1892VM14_CMCTR_GATE_DSP_DSP0_EN |
									MC1892VM14_CMCTR_GATE_DSP_DSP1_EN |
									MC1892VM14_CMCTR_GATE_DSP_DSPEXT_EN |
									MC1892VM14_CMCTR_GATE_DSP_DSPENC_EN);
