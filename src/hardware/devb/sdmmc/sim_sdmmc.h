...
#ifndef __DEVB_NAME__
# define __DEVB_NAME__ 					devb-sdmmc-e3845
#endif
...
#define SDMMC_EFLAG_PWROFF_NOTIFY		(1 << 8)
...
extern long sdmmc_sim_init( SIM_HBA *hba, long path );
extern long sdmmc_sim_action( SIM_HBA *hba, CCB *ccb_ptr );
extern void *sdmmc_driver_thread( void *data );
extern void sdmmc_display_ccb( SIM_HBA *hba, CCB *ccb );
...
extern int sdmmc_set_thread_state( uint32_t *tstate, int state );
extern int sdmmc_create_thread( pthread_t *tid, pthread_attr_t *aattr, void *(*func)(void *), void *arg, int priority, uint32_t *tstate, char *name );
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.5.0/trunk/hardware/devb/sdmmc/sim_sdmmc.h $ $Rev: 777274 $")
#endif
