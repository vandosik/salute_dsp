...
#define	SDHCI_ISE				0x38	// Interrupt signal enable register
	...
	#define SDHCI_INTR_DFLTS		0x110f80c0
//	#define SDHCI_INTR_DFLTS		(SDHCI_INTR_CIE | SDHCI_INTR_CEB | SDHCI_INTR_CCR | SDHCI_INTR_CTO | SDHCI_INTR_ERRI | SDHCI_INTR_CINS | SDHCI_INTR_CREM )
...
#define	SDHCI_HCTL2				0x3E	// Host Control 2
	...
	#define SDHCI_HCTL2_MODE_HS200		(0x5 << 0)
...
/* Tegra3 and Tegra124 Vendor Specific Registers */
#define SDHCI_VENDOR_CLK_CTRL   0x100
    #define SDHCI_TAP_VAL_MASK      (0xFF << 16)    // Tap value mask
    #define SDHCI_TAP_VAL           (0x6 << 16)     // Tap value [golden register value]

#define SDHCI_VENDOR_MISC       0x120
    #define SDHCI_CAP_DRIVE_TYPE_D  (1 << 6)
    #define SDHCI_CAP_DRIVE_TYPE_C  (1 << 5)
    #define SDHCI_CAP_DRIVE_TYPE_A  (1 << 4)
    #define SDHCI_CAP_DDR50         (1 << 2)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.5.0/trunk/hardware/devb/sdmmc/sdiodi/hc/sdhci.h $ $Rev: 747502 $")
#endif
