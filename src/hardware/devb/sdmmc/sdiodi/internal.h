...
#define DEV_FLAG_DDR			0x200		// DDR
#define DEV_FLAG_UHS			0x400		// UHS
#define DEV_FLAG_BKOPS			0x800		// BKOPS
#define DEV_FLAG_SIG_ERR		0x1000		// signal switch error
#define DEV_FLAG_WRITE_PROTECT	0x2000		// write protected
	_Uint32t				flags;
...
/********************************** struct _sdio_hc_cfg - Host Controller Configuration **********************************/
struct _sdio_hc_cfg {
...
#define	HC_CAP_XPC_3_3V				(1 << 16)	// > 150mA at 3.3V is supported
#define	HC_CAP_XPC_3_0V				(1 << 17)	// > 150mA at 3.0V is supported
#define	HC_CAP_XPC_1_8V				(1 << 18)	// > 150mA at 1.8V is supported
#define HC_CAP_XPC( _caps )			( ( ( _caps ) >> 16 ) & 0x07 )

#define	HC_CAP_200MA 				(1 << 19)	// 200mA at 1.8V
#define	HC_CAP_400MA 				(1 << 20)	// 400mA at 1.8V
#define	HC_CAP_600MA 				(1 << 21)	// 600mA at 1.8V
#define	HC_CAP_800MA 				(1 << 22)	// 800mA at 1.8V
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.5.0/trunk/hardware/devb/sdmmc/sdiodi/internal.h $ $Rev: 720123 $")
#endif
