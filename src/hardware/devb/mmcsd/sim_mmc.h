...
#define MMC_TIME_DEFAULT	5
#define MMC_TIME_INFINITY	0xffffffff
...
extern int mmc_wait_command(SIM_HBA *hba, int timeo);
extern int mmc_wait_card_ready(SIM_HBA *hba);
extern int mmc_get_card_status( SIM_HBA *hba );
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.5.0/trunk/hardware/devb/mmcsd/sim_mmc.h $ $Rev: 769650 $")
#endif
