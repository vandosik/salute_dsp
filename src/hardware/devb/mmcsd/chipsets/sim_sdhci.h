 ...
 */
#define	SDHCI_CLKCTL_DIV_SHIFT	8
...
#define	SDHCI_DMABUF_PIODSC	512
} sdhci_ext_t;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.5.0/trunk/hardware/devb/mmcsd/chipsets/sim_sdhci.h $ $Rev: 735968 $")
#endif
