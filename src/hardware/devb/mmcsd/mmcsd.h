...
#define EXT_CSD_CARD_TYPE_200		(1<<4)	/* Card can run at 200MHz 1.8V */

#define EXT_CSD_CARD_TYPE_52_CAPABLE (EXT_CSD_CARD_TYPE_52 | EXT_CSD_CARD_TYPE_DDR_52 | EXT_CSD_CARD_TYPE_DDR_52_LV | EXT_CSD_CARD_TYPE_200)
#define EXT_CSD_CARD_TYPE_26_CAPABLE (EXT_CSD_CARD_TYPE_26 | EXT_CSD_CARD_TYPE_52_CAPABLE)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.5.0/trunk/hardware/devb/mmcsd/mmcsd.h $ $Rev: 809661 $")
#endif
