	...
	while (*options != '\0') {
		...
		switch (opt) {
			...
			case 11:
				...
				break;
			case 12:
				ext->channel = strtoull(value, 0, 0);
				break;
		}
	}
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.5.0/trunk/hardware/devb/mmcsd/sim.c $ $Rev: 769650 $")
#endif
